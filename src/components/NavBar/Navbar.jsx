    ...
    <div>
        ...
        <div className='bg-nav h-28 flex items-center lg:justify-center justify-around  w-full xl:gap-16 fixed z-50 '>
          ...
          {/* Menu icon */}
            ...
            {/* Opciones */}
            <div className={`ml-28 absolute lg:static left-0 top-28 px-16 lg:px-0 py-2 lg:py-0 bg-nav   lg:z-auto z-[-1] transition-all duration-1000 ease-in ${isOpen ? 'left-0' : 'left-[-490px]'} `}>
              <ul className='flex lg:flex-row flex-col  justify-center items-center -mx-8'>
