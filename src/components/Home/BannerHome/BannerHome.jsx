...
const BannerHome = () => {
	return (
		<section className="flex flex-row lg:p-24 gap-3 lg:gap-14 ml-5 lg:ml-[5rem]" id="home">
			<div className="flex flex-col justify-center gap-10 lg:basis-1/2 w-80  text-left lg:pt-14">
			...
			<div className="pt-1.5 bg-[url('images/home.png')]  h-[31rem] w-64 lg:w-[28rem] rounded-t-[12.5rem] shadow-2xl shadow-black bg-cover lg:mt-16"></div>
		</section>
	);
};
