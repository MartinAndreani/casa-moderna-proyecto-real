...
const BannerHome = () => {
	return (
		<section className="flex flex-row p-24 gap-14 py-40 ml-[5rem]" id="home">
			...
			<div className="pt-1.5 bg-[url('images/home.png')] h-[31rem] w-[28rem] rounded-t-[12.5rem] shadow-2xl shadow-black bg-cover"></div>
		</section>
	);
};
